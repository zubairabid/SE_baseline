...
tf.app.flags.DEFINE_string('test_data_path', '../../app/static/img/images/', '')
tf.app.flags.DEFINE_string('output_path', '../../tmp/', '')
...
def dump_segments(filepath):
    tf.app.flags.DEFINE_string('filepath', filepath, '')
    return tf.app.run()
